...
const UpdateProfileDialog = ({ open, setOpen }) => {
  ...
  const [resumeUrl, setResumeUrl] = useState(user?.profile?.resume || '') // cloudinary link
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setResumeUrl(res.data.user.profile.resume) // ✅ update with new Cloudinary URL
            ...
            <DialogFooter>
              {loading ? (
                ...
                <Button
                  variant="outline"
                  type="submit"
                  className="w-full my-4 bg-sky-700 text-white"
                >
                  Update
                </Button>
              )}
